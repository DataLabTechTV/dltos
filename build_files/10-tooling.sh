...
install_shell_tools() {
    ...
    dnf5 -y install chezmoi direnv keychain zoxide bat ripgrep fd-find eza ncdu age btop nvtop tldr trash-cli \
        perl-Image-ExifTool
...
install_data_tools() {
    dnf5 -y install jq yq sqlite3 miller gnuplot parallel
